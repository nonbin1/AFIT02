$(document).ready(function ads() {
  ...
  $(document).ready(function apprecommend() {
      $.ajax({
          url: 'http://ad.flutx.com/applist.php?cat=FIT&thisid=AFIT02',
          type: "GET",
          dataType: "jsonp",
          async: false,
          success: function(data) {
...
var app = {
    ...
    onDeviceReady: function() {
        ...
        if (window.plugins && window.plugins.AdMob) {
            var admob_ios_key = 'a153563e3e86f45';
            var admob_android_key = 'a153563e3e86f45';
